...
function App() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    setForm({ ...form, [e.target.name]: e.target.value as FormState[keyof FormState] });
  };
  ...
  const handleSubmit = () => {
    ...
    const specialCombo = `${form.gender}_${form.smoker}_${form.icci}_${age}` as const;
    ...
    if (entry) {
      ...
      const premium = entry.premium || 'N/A';
